            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Welcome to your Admin Panel, <small><?php echo $_SESSION['username']; ?></small>
        ...
        <div class="panel panel-red">
            ...
            <a href="categories.php">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM comments WHERE comment_status = 'unnapproved'";
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        ['Data', 'Count'],
                        <?php
                            $elements_text = ['All Posts', 'Active Posts', 'Draft Posts', 'Unapproved Comments', 'Subscribers', 'Categories', 'Users', 'Comments'];
                            $elements_count = [$post_counts, $published_post_counts, $draft_post_counts, $unapproved_comment_counts, $subscriber_count, $categories_counts, $users_counts, $comment_counts];
